...
var deadboltPasswordGenerator = new function () {
    this.generatePassword = function (passPhrase, pin, useSpecial, caseSensitive, passwordLength) {
